...
<template>
  <VOverlay>
    <div class="h-full flex justify-center items-center">
      <div
        class="w-[330px] h-44 bg-[#1F1F1F] p-4 rounded-[10px] text-white_solid-default space-y-10"
      >
        <div class="space-y-2.5">
          <h3>Delete a Chain</h3>
          <p v-if="isGasTankConfigured" class="text-system-grey leading-4">
            Warning: A Gastank is configured for this chain. Deleting this chain
            may disable the Gastank.
          </p>
          <p v-else class="text-system-grey leading-4">
        ...
        <div class="space-x-2.5 flex justify-end text-sm">
          ...
          <button
            class="bg-white text-black_solid-default w-[100px] p-2 rounded-md"
