...
const delegateName = ref(props.delegateInfo.name)
const selectedDelegateAddress = ref('')

onMounted(() => {
  selectedDelegateAddress.value = props.delegateInfo.address
})
...
async function onSubmit() {
  ...
  try {
    ...
    await revokeDelegate(appId, props.delegateInfo.address)
    await grantDelegate(appId, address, permissions)
        ...
        <VStack gap="1rem" direction="column">
          ...
          <VStack direction="column" gap="1.5rem">
            ...
            <VStack gap="0.5rem" direction="column">
              ...
              <VStack gap="1rem">
                <VDropdown
                  v-model="selectedDelegateAddress"
