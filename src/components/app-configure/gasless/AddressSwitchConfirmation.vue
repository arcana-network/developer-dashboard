  ...
  <VOverlay>
    <div class="h-full flex">
      ...
      >
        ...
        />
        <p>Confirm Switch</p>
        <div class="text-[#8D8D8D] text-sm text-center space-y-2">
        ...
        <div class="space-x-2 text-sm">
          <button
            class="uppercase border-2 border-white rounded-md w-24 h-9"
            @click.stop="emits('close')"
          >
            Cancel
          </button>
          <button
            class="uppercase rounded-md bg-white text-black w-24 h-9"
