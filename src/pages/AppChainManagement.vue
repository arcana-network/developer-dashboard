...
<template>
  <div class="space-y-10 relative">
    <div class="space-y-[15px]">
      ...
      <p class="font-body text-[14px] text-secondary leading-[150%]">
    ...
    <div class="flex flex-col space-y-5">
      <div class="flex w-full justify-between gap-5 items-center">
        <div class="flex gap-2 items-center">
          <span class="text-secondary text-xs">Chain Type</span>
          <span
            v-if="
          ...
          >
          <span v-else class="text-secondary text-md">{{
        ...
        <div class="flex items-center flex-grow justify-end space-x-5">
          <button
            v-if="
              chainManagementStore.selectedChainType?.toLowerCase() === 'evm'
            "
            class="text-black flex items-center space-x-1.5 hover:text-rose"
            @click="openForm('add')"
          >
            <span>Add Chain</span>
          </button>
